...
==========================
Production FHIR R5 server implementation with full resource support,
search capabilities, transaction bundles, and SMART on FHIR authentication.
...
Implements:
    ...
    - US Core 6.0 profiles
    - IPA (International Patient Access) profile

Key FHIR resources supported (400+ total):
...
def build_capability_statement(base_url: str) -> Dict[str, Any]:
    ...
    return {
        ...
        "description": (
            "MedIntelOS FHIR R5 server — full-featured, production-ready, "
            "open-source medical intelligence operating system."
        ),
        ...
        "rest": [{
            ...
            "security": {
                ...
                "description": "SMART on FHIR 2.0 with OpenID Connect",
                "extension": [{
...
def _build_resource_capabilities() -> List[Dict[str, Any]]:
    ...
    resources = [
        ("Patient", ["read", "vread", "update", "patch", "delete", "create", "search-type", "history-instance"]),
        ("Encounter", ["read", "update", "create", "search-type", "history-instance"]),
        ("Observation", ["read", "update", "create", "search-type", "history-instance"]),
        ("Condition", ["read", "update", "create", "search-type"]),
        ("Procedure", ["read", "update", "create", "search-type"]),
        ("MedicationRequest", ["read", "update", "create", "search-type"]),
        ("DiagnosticReport", ["read", "update", "create", "search-type"]),
        ("AllergyIntolerance", ["read", "update", "create", "search-type"]),
        ("Immunization", ["read", "update", "create", "search-type"]),
        ("CarePlan", ["read", "update", "create", "search-type"]),
        ("ServiceRequest", ["read", "update", "create", "search-type"]),
        ("Device", ["read", "update", "create", "search-type"]),
        ("DocumentReference", ["read", "update", "create", "search-type"]),
        ("Consent", ["read", "update", "create", "search-type"]),
        ("AuditEvent", ["read", "create", "search-type"]),
        ("Bundle", ["read", "create", "search-type"]),
    ]
    ...
    for resource_type, interactions in resources:
        capabilities.append({
            ...
            "searchRevInclude": [f"Observation:subject"],
        })
